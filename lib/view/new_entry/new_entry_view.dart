              ...
              TextButton(
                onPressed: () async {
                  ...
                  if (novaCategoria.isNotEmpty &&
                      !_settings.categorias.contains(novaCategoria)) {
                    setState(() {
            ...
            actions: [
              ...
              TextButton(
                onPressed: () async {
                  ...
                  if (novoCartao.isNotEmpty &&
                      !_settings.cartoes.contains(novoCartao)) {
                    setState(() {
              ...
              TextButton(
                onPressed: () async {
                  ...
                  if (novoNome.isNotEmpty &&
                      !_settings.categorias.contains(novoNome)) {
                    setState(() {
                      final index = _settings.categorias.indexOf(
                        categoriaAntiga,
                      );
            ...
            actions: [
              ...
              TextButton(
                onPressed: () async {
                  final novoNome = _controller.text.trim();
                  if (novoNome.isNotEmpty &&
                      !_settings.cartoes.contains(novoNome)) {
                    setState(() {
                              ...
                              child: GestureDetector(
                                onLongPress: () {
                                  Future.delayed(
                                    ...
                                    () {
                                      _mostrarPopupEditarOuExcluirCategoria(
                                        cat,
                                      );
                                    },
                                  );
